...
<div class="todo">
  ...
  <div id="contenido">
      ...
      <input type="hidden" name="id_producto"  value="<?php echo $_GET['id_producto']?>">
  		...
  		<input type="text" id="nombre_producto" name="nombre_producto" value="<?php echo $consulta[0] ?>" ><br>
  		
  		<label>Precio Producto: </label>
  		<input type="text" id="precio_producto" name="precio_producto" value="<?php echo $consulta[1] ?>"><br>

      <label>Stock: </label>
      <input type="text" id="stock" name="stock" value="<?php echo $consulta[2] ?>"><br>
  		
  		<label>Id Categoria: </label>
  		<input type="text" id="id_categoria" name="id_categoria" value="<?php echo $consulta[3] ?>"><br><br>
  		<br>
      <input type="hidden" id="id_categoria2" name="id_categoria2" value="<?php echo $consulta[3] ?>">
